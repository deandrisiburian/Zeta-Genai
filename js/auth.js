...
function sendVerificationCode() {
  ...
  setTimeout(() => {
    alert(`DEMO: Kode verifikasi Anda adalah ${code}. Dalam aplikasi nyata, ini akan dikirim ke email Anda.`);
  }, 500);
}
...
function upgradeToPremium() {
  if (!userState.isLoggedIn) {
    showNotification('Silakan masuk terlebih dahulu untuk upgrade', 'error');
    showLoginModal();
    return;
  }
  ...
  showNotification('Berhasil upgrade ke Premium!', 'success');
}
